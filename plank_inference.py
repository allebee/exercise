...
# Instantiate the PlankDetection class
...
async def websocket_endpoint(websocket: WebSocket):
    ...
    try:
        while True:
            ...
            # Detect plank pose errors using PlankDetection
            if results.pose_landmarks:
                plank_detector.detect(results, img, timestamp=0)  # Assuming timestamp is 0 for simplicity
