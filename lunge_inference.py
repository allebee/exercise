...
import numpy as np
import base64
from lunge import LungeDetection  # Assuming LungeDetection is in this module
...
async def websocket_endpoint(websocket: WebSocket):
    ...
    try:
        while True:
            ...
            # Perform lunge detection using LungeDetection
            if results.pose_landmarks:
                timestamp = 0  # For simplicity, using 0 as a timestamp
                lunge_detector.detect(results, img, timestamp)
